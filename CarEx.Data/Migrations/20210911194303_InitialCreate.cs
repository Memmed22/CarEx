        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TelNo = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    Email = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    SpendingLimit = table.Column<double>(type: "float", nullable: false),
                    Photo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedOn = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TelNo2 = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    ResponsibleName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    ResponsibleTelNo = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShipmentCompany", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ShipmentCompany_Employee_EmployeeId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DriverTelNo = table.Column<string>(type: "nvarchar(40)", maxLength: 40, nullable: true),
                    EstimatedDeliverDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Shipment_ShipmentCompany_ShipmentCompanyId",
                        column: x => x.ShipmentCompanyId,
                        principalTable: "ShipmentCompany",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Parcel_Employee_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employee",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Comment = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    InvoicePrice = table.Column<double>(type: "float", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Package_Employee_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employee",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Package_Parcel_ParcelId",
                        column: x => x.ParcelId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Package_EmployeeId",
                table: "Package",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_Package_ParcelId",
                table: "Package",
                column: "ParcelId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shipment_ShipmentCompanyId",
                table: "Shipment",
                column: "ShipmentCompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_ShipmentCompany_EmployeeId",
                table: "ShipmentCompany",
                column: "EmployeeId");
